...
class ConduitEventTest < Minitest::Test
  def test_construction_with_keyword_args
    e = ConduitSSE::Event.new(event: "message", data: "hi", id: "1", retry: 5000)
  ...
  def test_value_equality
    a = ConduitSSE::Event.new(event: "m", data: "x", id: nil, retry: nil)
    b = ConduitSSE::Event.new(event: "m", data: "x", id: nil, retry: nil)

    assert_equal a, b
  end

  def test_is_immutable
    e = ConduitSSE::Event.new(event: "m", data: "x", id: nil, retry: nil)
